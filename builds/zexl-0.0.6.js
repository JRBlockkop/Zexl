...
const {LoginSuccess,Login} = __require(8)
const {PlayerInfoUpdate} = __require(9)
const {knownPacks} = __require(11)
const Packet = __require(3)
const game = __require(6)
...
const {Handshake,Acknowledg} = __require(7)
const {ChatClientCommand,ChatClientMessage} = __require(12)
const {RegistryData} = __require(13)
